...
|    接口地址    | 请求方式 | 参数 |         接口描述         |
| :------------: | :------: | :--: | :----------------------: |
| /cart/get_cart |   get    |  无  | 获取当前用户的购物车数据 |
...
|      接口地址       | 请求方式 | 参数 |     接口描述     |
| :-----------------: | :------: | :--: | :--------------: |
| /order/create_order |   post   |  无  | 用于提交生成订单 |
...
|     接口地址     | 请求方式 | 参数 |       接口描述       |
| :--------------: | :------: | :--: | :------------------: |
| /order/get_order |   post   |  无  | 查询当前用户订单状态 |
...
|  接口地址  | 请求方式 |   参数   |    接口描述    |
| :--------: | :------: | :------: | :------------: |
| /order/del |   get    | order_id | 删除指定的订单 |

## 6.取消订单

|   接口地址    | 请求方式 |   参数   |            接口描述             |
| :-----------: | :------: | :------: | :-----------------------------: |
| /order/cancel |   get    | order_id | 用于取消当前订单,但是仍然有几率 |

## 7.支付

### 微信支付

|  接口地址  | 请求方式 |     参数     |       接口描述       | 是否必传 |
| :--------: | :------: | :----------: | :------------------: | :------: |
| /pay/wepay |   post   |    appid     |      公众账号ID      |    是    |
|            |          |    mch_id    | 微信支付分配的商户号 |    是    |
|            |          | out_trade_no |      商品订单号      |    是    |
|            |          |     body     |       商品描述       |    是    |